...
#[openapi(
    paths(
        ...
        player::list_owned_pachimon_handler,
        player::set_party_handler,
        player::update_pachimon_move_handler,
    ...
    components(schemas(
        ...
        player::ListOwnedPachimonResponse,
        player::PartySlotRequest,
        player::SetPartyRequest,
        player::PartySlotDto,
        player::SetPartyResponse,
        player::UpdateMoveRequest,
        player::UpdateMoveResponse,
